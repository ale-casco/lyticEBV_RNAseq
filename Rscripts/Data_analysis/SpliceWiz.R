...
#WT_EvL_res.ori = WT_EvL_res
#dBGLF5_EvL_res.ori = dBGLF5_EvL_res
#WT_EvL_novel_res.ori = WT_EvL_novel_res
#WT_LvL_novel_res.ori = WT_LvL_novel_res
dBGLF5_EvL_novel_res.ori = dBGLF5_EvL_novel_res
#WT_LvL_res.ori = WT_LvL_res
#dBGLF5_LvL_res.ori = dBGLF5_LvL_res
#WT_LvL_novel_res.ori = WT_LvL_novel_res
#dBGLF5_LvL_novel_res.ori = dBGLF5_LvL_novel_res

WT_EvL_res = WT_EvL_res.ori
dBGLF5_EvL_res = dBGLF5_EvL_res.ori
WT_EvL_novel_res = WT_EvL_novel_res.ori
WT_LvL_novel_res = WT_LvL_novel_res.ori
dBGLF5_EvL_novel_res = dBGLF5_EvL_novel_res.ori
WT_LvL_res = WT_LvL_res.ori
dBGLF5_LvL_res = dBGLF5_LvL_res.ori
WT_LvL_novel_res = WT_LvL_novel_res.ori
dBGLF5_LvL_novel_res = dBGLF5_LvL_novel_res.ori
