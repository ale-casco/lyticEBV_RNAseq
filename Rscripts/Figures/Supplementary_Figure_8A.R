...
df_out$Condition = sub("dBGLF5_","",df_out$Condition)
...
ggsave(file.path(out_dir,"Supplementary_Figure_8A.svg"), dpi = 300, width = 5.21, height = 5.21, units = "in")
