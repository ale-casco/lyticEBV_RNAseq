...
# Output directory
out_dir=file.path(work_dir, "Figures/Supplementary_Figure_5")
...
deg_early = read.csv(file.path(deg_dir, "ERCCnorm_DE.WT_Early.vs.WT_Latent.csv"),check.names = TRUE)
deg_late = read.csv(file.path(deg_dir, "ERCCnorm_DE.WT_Late.vs.WT_Latent.csv"),check.names = TRUE)
...
ggsave(file.path(out_dir, "Supplementary_Figure_5A.Early.png"), dpi = 300, width = 5.21, height = 5.21, units = "in")

# expression late
expression_plot_late + theme_white
ggsave(file.path(out_dir, "Supplementary_Figure_5A.Late.png"), dpi = 300, width = 5.21, height = 5.21, units = "in")

# Half-life early
hl_plot_early + theme_white
ggsave(file.path(out_dir, "Supplementary_Figure_5B.Early.png"), dpi = 300, width = 5.21, height = 5.21, units = "in")

# Half-life late
hl_plot_late + theme_white
ggsave(file.path(out_dir, "Supplementary_Figure_5B.Late.png"), dpi = 300, width = 5.21, height = 5.21, units = "in")
...
ggsave(file.path(out_dir, "Supplementary_Figure_5A.Early.svg"), dpi = 300, width = 5.21, height = 5.21, units = "in")
...
ggsave(file.path(out_dir, "Supplementary_Figure_5A.Late.svg"), dpi = 300, width = 5.21, height = 5.21, units = "in")
...
ggsave(file.path(out_dir, "Supplementary_Figure_5B.Early.svg"), dpi = 300, width = 5.21, height = 5.21, units = "in")
...
ggsave(file.path(out_dir, "Supplementary_Figure_5B.Late.svg"), dpi = 300, width = 5.21, height = 5.21, units = "in")
