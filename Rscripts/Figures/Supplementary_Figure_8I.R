...
# DESeq2 differential read-in files
de_ri_dir = file.path(work_dir, "Data/ARTDeco_DESeq2/readin")
...
# Load differential read-in events
df_WT_early = read.csv(file.path(de_ri_dir, "ERCCnorm_DE.WT_Early.vs.WT_Latent.csv"))
df_WT_late = read.csv(file.path(de_ri_dir, "ERCCnorm_DE.WT_Late.vs.WT_Latent.csv"))
df_dBGLF5_early = read.csv(file.path(de_ri_dir, "ERCCnorm_DE.dBGLF5_Early.vs.dBGLF5_Latent.csv"))
df_dBGLF5_late = read.csv(file.path(de_ri_dir, "ERCCnorm_DE.dBGLF5_Late.vs.dBGLF5_Latent.csv"))
...
ggsave(file.path(out_dir,"Supplementary_Figure_8I.png"), dpi = 300, width = 4.34, height = 7.27, units = "in")
...
background_plot + geom_smooth(method = "lm", se = FALSE, color = "blue") + 
  ...
  geom_abline(slope = 1, color = "red", linetype = "dashed")
ggsave(file.path(out_dir,"Supplementary_Figure_8I.Background.svg"), dpi = 300, width = 4.34, height = 7.27, units = "in")
